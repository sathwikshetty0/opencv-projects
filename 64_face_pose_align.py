    ...
    with mp_face.FaceMesh(max_num_faces=1, min_detection_confidence=0.7, min_tracking_confidence=0.7) as face_mesh:
        while cap.isOpened():
            ...
            if results.multi_face_landmarks:
                ...
                left = points[234]; right = points[454]; nose = points[1]; cv2.line(output, left, right, (255,0,0), 2); cv2.line(output, nose, (nose[0], nose[1]-80), (0,255,0), 2)

            cv2.putText(output, 'Show face pose axes and alignment guides', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
            cv2.putText(output, 'Press q to quit', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1)
            cv2.imshow('64 Face Pose Align', output)
