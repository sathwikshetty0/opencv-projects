    ...
    with mp_hands.Hands(max_num_hands=1, min_detection_confidence=0.7, min_tracking_confidence=0.7) as hands:
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks:
                ...
                angle = math.degrees(math.atan2(index_pos[1] - thumb_pos[1], index_pos[0] - thumb_pos[0])); cv2.putText(output, f"Scroll Angle: {int(angle)}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,255,255), 2)

            cv2.putText(output, 'Scroll through a virtual panel with hand tilt', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
            cv2.putText(output, 'Press q to quit', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1)
            cv2.imshow('49 Hand Scroll Control', output)
