    ...
    with mp_face.FaceMesh(max_num_faces=1, min_detection_confidence=0.7, min_tracking_confidence=0.7) as face_mesh:
        while cap.isOpened():
            ...
            if results.multi_face_landmarks:
                ...
                left_eye = points[33]; right_eye = points[263]; cv2.circle(output, left_eye, 40, (200,200,255), -1); cv2.circle(output, right_eye, 40, (200,200,255), -1)

            cv2.putText(output, 'Mirror the face into stylized sunglasses', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
            cv2.putText(output, 'Press q to quit', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1)
            cv2.imshow('61 Face Mirror Glass', output)
