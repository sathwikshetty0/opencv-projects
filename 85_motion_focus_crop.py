...
def main():
    ...
    while cap.isOpened():
        ...
        prev_frame = gray
        cv2.putText(output, 'Automatically crop to the most active motion region', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
        cv2.putText(output, 'Press q to quit', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1)
        cv2.imshow('85 Motion Focus Crop', output)
